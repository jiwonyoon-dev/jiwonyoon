        ...
        <section>
          ...
          <div className="section-divider grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="rounded-lg bg-white p-6 shadow">
              ...
              <p>
                현장 업무의 비효율을 스스로 발견하고 이슈 리포터 서비스라는 기술적 솔루션을 기획·구현·개선하여 팀
                생산성을 높이고 사내 공식 플랫폼으로 채택되는 성과를 이끌어냈습니다. 6,000건 이상의 이슈를 체계적으로
            ...
            <div className="rounded-lg bg-white p-6 shadow">
              ...
              <p>
                ...
                효과를 효과적으로 관리했습니다. 또한 Next.js 프로젝트에서 Custom Hook과 컴포넌트 기반 기능(회원 관리
                등)을 구현한 경험이 있습니다.
              </p>
            </div>
          </div>
